    ...
    <div>
      ...
      <FadeSection className="py-20 md:py-28" style={{ backgroundColor: '#FAFAF7' }}>
        <div className="max-w-[700px] mx-auto px-6 lg:px-8 text-center">
          ...
          <h2 className="text-[clamp(1.5rem,3vw,2rem)] font-bold text-[#1A1F2E] tracking-[-0.02em] mb-4">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <div key={step.num} className="bg-white rounded-[20px] p-7 apple-shadow text-center">
                <span className="inline-block text-[11px] font-semibold text-[#8B95A5] tracking-wider mb-3">{step.num}</span>
                <h3 className="font-semibold text-[16px] text-[#1A1F2E] mb-2">{step.title}</h3>
                <p className="text-[14px] text-[#8B95A5] leading-relaxed">{step.desc}</p>
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-[20px] p-8 apple-shadow">
              <div className="flex items-center gap-2 mb-5">
                ...
                <h3 className="font-semibold text-[16px] text-[#1A1F2E]">Not Eligible</h3>
              </div>
              <ul className="space-y-3">
      ...
      <FadeSection className="py-24" style={{ background: 'linear-gradient(135deg, #FFFDE7 0%, #F5F0FF 100%)' }}>
        <div className="max-w-[800px] mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-[#8B95A5] text-[15px] mb-8">Our support team is here to help, Monday through Friday.</p>
          <a href="mailto:support@aminoselect.com" className="btn-apple inline-flex items-center gap-2 bg-[#1A1F2E] text-white text-[15px] font-medium px-8 py-3.5 rounded-full">
            Contact Support
          </a>
        </div>
      </FadeSection>
