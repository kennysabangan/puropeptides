    ...
    return (
      <div className="min-h-[80vh] flex items-center justify-center px-6 py-14">
        <div className="w-full max-w-[440px] bg-white/85 backdrop-blur-xl rounded-3xl apple-shadow p-8 sm:p-10 text-center">
          <h1 className="text-[24px] font-bold text-[#1A1F2E] tracking-tight mb-3">Check your email</h1>
          <p className="text-[14px] text-[#8B95A5] mb-6">
            We sent a confirmation link to <strong className="text-[#1A1F2E]">{email}</strong>. Click it to
            activate your account.
          </p>
          <Link to="/login" className="inline-block px-5 py-2.5 rounded-full bg-[#1A1F2E] text-white text-[13px] font-medium btn-apple">
            Back to sign in
          </Link>
        </div>
      </div>
  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center px-6 py-14">
      <div className="w-full max-w-[440px] bg-white/85 backdrop-blur-xl rounded-3xl apple-shadow p-8 sm:p-10">
        <h1 className="text-[26px] font-bold text-[#1A1F2E] tracking-tight mb-2">Create account</h1>
        <p className="text-[13px] text-[#8B95A5] mb-7">For qualified researchers and laboratories.</p>

        <form onSubmit={handleSubmit} className="space-y-3">
          <div>
            <label className="block text-[12px] font-medium text-[#1A1F2E] mb-1.5">Full name</label>
            <input
              type="text"
              required
              value={fullName}
          ...
          <div>
            ...
            <input
              ...
              className="w-full rounded-2xl border border-black/10 bg-white px-4 py-3 text-[14px] text-[#1A1F2E] outline-none focus:border-[#1A1F2E] transition"
            />
            <p className="text-[11px] text-[#8B95A5] mt-1.5">Minimum 8 characters.</p>
          </div>
        ...
        <p className="text-[13px] text-[#8B95A5] mt-6 text-center">
          ...
          <Link to="/login" className="text-[#1A1F2E] font-medium hover:underline">Sign in</Link>
        </p>
      </div>
    </div>
  )
