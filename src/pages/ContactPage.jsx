      ...
      <FadeSection className="py-20 md:py-28" style={{ backgroundColor: '#FBFBFD' }}>
        <div className="max-w-[1200px] mx-auto px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-16">
            ...
            <div>
              <div className="mb-10">
                <h3 className="font-semibold text-[15px] text-[#1D1D1F] mb-2">Email Us</h3>
                <a href="mailto:support@aminoselect.com" className="text-[#1D1D1F] text-[17px] font-medium hover:underline">
                  support@aminoselect.com
                </a>
                <p className="text-[13px] text-[#86868B] mt-1">We respond within 24 hours, Monday through Friday.</p>
              </div>

              {submitted ? (
                <div className="bg-white rounded-[20px] p-8 apple-shadow text-center">
                  <div className="w-14 h-14 bg-[#E8F5ED] rounded-full flex items-center justify-center mx-auto mb-4">
                  ...
                  <h3 className="font-semibold text-[17px] text-[#1D1D1F] mb-2">Message Sent</h3>
                  <p className="text-[14px] text-[#86868B]">We'll get back to you within 24 hours.</p>
                </div>
              ) : (
                <form onSubmit={handleSubmit} className="bg-white rounded-[20px] p-8 apple-shadow space-y-5">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-xl border border-[#E8E8ED] bg-[#FBFBFD] text-[14px] focus:outline-none focus:ring-2 focus:ring-[#1D1D1F]/10 transition"
                    />
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      required
                      className="w-full px-4 py-3 rounded-xl border border-[#E8E8ED] bg-[#FBFBFD] text-[14px] focus:outline-none focus:ring-2 focus:ring-[#1D1D1F]/10 transition appearance-none"
                    >
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-4 py-3 rounded-xl border border-[#E8E8ED] bg-[#FBFBFD] text-[14px] focus:outline-none focus:ring-2 focus:ring-[#1D1D1F]/10 transition resize-none"
                    />
                  </div>
                  <button type="submit" className="btn-apple w-full bg-[#1D1D1F] text-white font-medium py-3.5 rounded-full text-[15px]">
                    Send Message
                  </button>
                </form>
              )}
            ...
            {/* Right: FAQ */}
            <div>
              <h3 className="font-semibold text-[20px] text-[#1D1D1F] mb-6">Frequently Asked</h3>
